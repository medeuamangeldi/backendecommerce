...
export class CartController {
  ...
  @ApiBearerAuth()
  async createDeliveryByCart(
    @Body() createDeliveryInfoDto: CreateDeliveryInfoDto,
  ) {
    return await this.deliveryInfoService.createDeliveryByCart(
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  async getDeliveryInfoNuCartId(@Param('cartId') cartId: string) {
    return await this.deliveryInfoService.getDeliveryInfoByCartId(+cartId);
  }
  ...
  async updateDeliveryInfo(
    ...
    return await this.deliveryInfoService.updateDeliveryInfo(
      +id,
